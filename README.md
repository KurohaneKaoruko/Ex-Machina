...
| 平台 | 安装文件位置 | 参考文档 |
|------|-------------|---------|
| Trae | `exmachina/trae/` | [trae/INSTALL.md](exmachina/trae/INSTALL.md) |
| OpenAI Codex | `exmachina/codex/` | [codex/INSTALL.md](exmachina/codex/INSTALL.md) |
| Cursor | `exmachina/cursor/` | 即将支持 |
| Claude Code | `exmachina/claude-plugin/` | 即将支持 |
| VS Code | `exmachina/vscode/` | 即将支持 |
| Kiro | `exmachina/kiro/` | 即将支持 |

### 快速开始

安装完成后，在对应工具中：

1. **使用 Skill**：加载 `exmachina/trae/skills/exmachina/SKILL.md` 或对应平台的 skill 文件
...
构建成功后，产物会生成到 `exmachina/` 目录下各平台对应的文件夹中。
