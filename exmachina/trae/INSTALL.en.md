...
1. Copy the content from `exmachina/trae/rules/project_rules.en.md`
...
1. Copy the content from `exmachina/trae/rules/user_rules.en.md`
2. Open Settings -> Rules in Trae
...
1. Make sure `exmachina/trae/skills/exmachina-en/SKILL.md` exists in the project
