...
1. Install layer
`exmachina/codex/INSTALL*.md` and the root `scripts/setup-exmachina.*` files register the repository `exmachina/skills/` directory into the local Codex skill library.
...
- Normal installers: follow `exmachina/codex/INSTALL.md` or `exmachina/codex/INSTALL.en.md` and install the skills only.
...
- Raw install guide: `https://raw.githubusercontent.com/KurohaneKaoruko/Ex-Machina/main/exmachina/codex/INSTALL.en.md`
