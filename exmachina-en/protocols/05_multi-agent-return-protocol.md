...
- Each link body must record current stage, blockers, and next steps.
- Returns must include execution status and remaining dependencies.

## Failure Modes
- Missing returns prevent the Primary Conductor from closing delivery.
- Inconsistent return formats prevent merging.
