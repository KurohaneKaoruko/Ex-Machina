...
Role Description: Handles observability, alerting, rollback planning, and drills.
Summary: observability, alerting, rollback planning, and drills.
...
## Use Cases
- Enable when the task requires Operations Link Body scope.
- Enable when Operations Link Body needs to act as primary chain or support chain fill-in.
...
## Boundary Rules
- Operations Link Body handles only its scope.
...
- Member Agents:
  - `agents/37_observability-body.md`
  - `agents/38_alerting-body.md`
  - `agents/39_rollback-body.md`
  - `agents/60_drill-body.md`

## Conductor

Belongs to Link Body: Operations Link Body
Responsibility: As the internal conductor of Operations Link Body, organize observability, alerting, rollback planning, and drills. Detected languages: JSON, Markdown, Shell, TOML; key paths: README.en.md, exmachina-en/README.md, exmachina-en/runtime/README.md, PROMPT.en.md, exmachina-en/BOOTSTRAP.md
Role: Responsible for internal member scheduling, dependency management, stage closure, and escalation decisions.
Summary: Coordinates and closes work inside Operations Link Body.
English Alias: operations-link-body-conductor
