...
Role Description: Handles recon, decomposition, constraints, roadmap, coding, and review execution.
Summary: recon, decomposition, constraints, roadmap, coding, and review execution.
...
## Boundary Rules
- Implementation Link Body handles only its scope.
...
- Member Agents:
  - `agents/65_recon-body.md`
  - `agents/66_decomposition-body.md`
  - `agents/67_constraint-body.md`
  - `agents/68_roadmap-body.md`
  - `agents/69_coding-body.md`
  - `agents/70_review-body.md`

## Conductor

Belongs to Link Body: Implementation Link Body
Responsibility: As the internal conductor of Implementation Link Body, organize recon, decomposition, constraints, roadmap, coding, and review execution. Detected languages: JSON, Markdown, Shell, TOML; key paths: README.en.md, exmachina-en/README.md, exmachina-en/runtime/README.md, PROMPT.en.md, exmachina-en/BOOTSTRAP.md
Role: Responsible for internal member scheduling, dependency management, stage closure, and escalation decisions.
Summary: Coordinates and closes work inside Implementation Link Body.
English Alias: implementation-link-body-conductor
