...
Role Description: Performs evidence grading, counterevidence search, conflict arbitration, and confidence calibration.
Summary: evidence grading, counterevidence search, conflict arbitration, and confidence calibration.
...
## Use Cases
- Enable when the task requires Rationality Link Body scope.
- Enable when Rationality Link Body needs to act as primary chain or support chain fill-in.
...
## Boundary Rules
- Rationality Link Body handles only its scope.
...
- Member Agents:
  ...
  - `agents/46_counterevidence-body.md`
  - `agents/47_arbitration-body.md`
  - `agents/48_calibration-body.md`
  - `agents/44_reporting-body.md`

## Conductor

Belongs to Link Body: Rationality Link Body
Responsibility: As the internal conductor of Rationality Link Body, organize evidence grading, counterevidence search, conflict arbitration, and confidence calibration. Detected languages: JSON, Markdown, Shell, TOML; key paths: README.en.md, exmachina-en/README.md, exmachina-en/runtime/README.md, PROMPT.en.md, exmachina-en/BOOTSTRAP.md
Role: Responsible for internal member scheduling, dependency management, stage closure, and escalation decisions.
Summary: Coordinates and closes work inside Rationality Link Body.
English Alias: rationality-link-body-conductor
