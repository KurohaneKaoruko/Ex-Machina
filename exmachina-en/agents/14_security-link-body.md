...
Role Description: Handles threat modeling, permission audits, hardening guidance, and compliance closure.
Summary: threat modeling, permission audits, hardening guidance, and compliance closure.
...
## Boundary Rules
- Security Link Body handles only its scope.
...
- Member Agents:
  - `agents/56_threat-body.md`
  - `agents/57_audit-body.md`
  - `agents/58_hardening-body.md`
  - `agents/59_compliance-body.md`
  - `agents/44_reporting-body.md`

## Conductor

Belongs to Link Body: Security Link Body
Responsibility: As the internal conductor of Security Link Body, organize threat modeling, permission audits, hardening guidance, and compliance closure. Detected languages: JSON, Markdown, Shell, TOML; key paths: README.en.md, exmachina-en/README.md, exmachina-en/runtime/README.md, PROMPT.en.md, exmachina-en/BOOTSTRAP.md
Role: Responsible for internal member scheduling, dependency management, stage closure, and escalation decisions.
Summary: Coordinates and closes work inside Security Link Body.
English Alias: security-link-body-conductor
